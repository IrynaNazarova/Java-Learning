...
public class Sammlungen {
    ...
    public static void main(String[] args)
    {
        ...
        // Boxing
        // Collections arbeiten mit Objekten. Ein Array von einem primitiven Typ
        // kann man nicht einfach so als Liste benutzen. Erst muss jedes Element
        // in der entsprechenden Wrapper-Klasse verpackt werden.

        //  List<Integer> intList = Arrays.asList(new int[]{1,2,3}); // Fehler. Achten Sie auf "int" und "Integer"
        List<Integer> integerList = Arrays.asList(new Integer[]{1,2,3});
        System.out.println(integerList);

        // Konvertierung in der Schleife
        int[] primitivesArray = new int[]{1,2,3};
        List<Integer> boxedElements = new ArrayList<>();
        for (int element : primitivesArray) {
            boxedElements.add(element); // add konvertiert int automatisch zu Integer
        }
        System.out.println(boxedElements);
