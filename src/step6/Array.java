...
public class Array {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println();
        System.out.println("ARRAYS KOPIEREN");

        System.out.println("Referenz und keine Kopie:");
        ...
        myOtherArray = Arrays.copyOf(myArray, myArray.length);
        myOtherArray[0] = 5;
        System.out.println(Arrays.toString(myArray));
        System.out.println(Arrays.toString(myOtherArray));

        System.out.println("Kopie mit Streams:");
        myArray = new int[]{3, 2, 1};
        myOtherArray = Arrays.stream(myArray).toArray();
        myOtherArray[0] = 5;
        System.out.println(Arrays.toString(myArray));
        System.out.println(Arrays.toString(myOtherArray));

        System.out.println("Kopie sortiert mit Streams:");
        myArray = new int[]{3, 2, 1};
        myOtherArray = Arrays.stream(myArray).sorted().toArray();
        System.out.println(Arrays.toString(myArray));
        System.out.println(Arrays.toString(myOtherArray));
